<%-- 
    Document   : UserLibrary
    Created on : 6 Jul, 2016, 1:33:07 AM
    Author     : Jalaz
    Description: Page Displaying the library for the Subscribers of the Book portal, Containing filters and modified search 
                 records,
                 Clicking on a book, will take you to UserLibraryBookDetails.jsp , giving you 2 options UserLibraryBuyBook.jsp
                 and UserLibraryBookReviews.jsp
--%>
...
<%-- ------------------------------------ Top Layout for filters and searching ---------------------------------- --%>
        ...
        <div style="height: 60px; width: 100%; margin-left: 0px; margin-top: 20px">
                <div style="height: 50px; width: 25%; text-align: center; float: left">
                    <form method="post" action="UserLibrary.jsp">
