                    ...
                    <legend> Rating & Reviews </legend>
                        <form name="reviewForm" method="post" id="formRating" action="reviewSubmitServlet">
                            ...
                            <div class="rating" style="margin-right: 100px;">
                                 <span><input type="radio" name="rating" id="str5" onclick="enableSubmit();" value="5"/> <label for="str5"> <img style="width: 25px; height: 25px" src="ProjectImages/star.png" /> </label> </span>
                                 <span><input type="radio" name="rating" id="str4" onclick="enableSubmit();" value="4"/> <label for="str4"> <img style="width: 25px; height: 25px" src="ProjectImages/star.png" /> </label> </span>
                                 <span><input type="radio" name="rating" id="str3" onclick="enableSubmit();" value="3"/> <label for="str3"> <img style="width: 25px; height: 25px" src="ProjectImages/star.png" /> </label> </span>
                                 <span><input type="radio" name="rating" id="str2" onclick="enableSubmit();" value="2"/> <label for="str2"> <img style="width: 25px; height: 25px" src="ProjectImages/star.png" /> </label> </span>
                                 <span><input type="radio" name="rating" id="str1" onclick="enableSubmit();" value="1"/> <label for="str1"> <img style="width: 25px; height: 25px" src="ProjectImages/star.png" /> </label> </span>
